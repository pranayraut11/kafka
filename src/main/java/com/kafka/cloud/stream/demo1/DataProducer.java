...
public class DataProducer {
	...
	DataProducer() {
		...
		properties.setProperty(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG,
				AppSerdis.User().serializer().getClass().getName());
	...
	public ProducerRecord<Integer, User> generateData(Integer key, User user, int partitionNumber) {
		LOG.info("-----Sending data------");
		LOG.info("-----Key : {} Value : {}", key, user);
		return new ProducerRecord<Integer, User>(AppConstants.TOPIC_WITH_PARTITION, partitionNumber, key, user);
	}
